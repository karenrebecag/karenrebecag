...
Below is my toolkit for crafting sleek, user-friendly, and innovative web solutions, organized by category. All icons are powered by [skill-icons](https://github.com/tandpfun/skill-icons).

### 🎨 UI/UX Design
[![My Skills](https://skillicons.dev/icons?i=figma,sketch)](https://skillicons.dev)

### 💻 Frontend
[![My Skills](https://skillicons.dev/icons?i=js,ts,react,nextjs,html,css,redux,jquery,sass,tailwind,bootstrap)](https://skillicons.dev)

### ⚙️ Backend
[![My Skills](https://skillicons.dev/icons?i=nodejs,py,fastapi)](https://skillicons.dev)

### 🗄️ Databases
[![My Skills](https://skillicons.dev/icons?i=postgres,firebase,mongodb,redis,mysql)](https://skillicons.dev)

### 🤖 AI & Automation
[![My Skills](https://skillicons.dev/icons?i=tensorflow,pytorch)](https://skillicons.dev)

### 🎥 Animations & 3D
[![My Skills](https://skillicons.dev/icons?i=threejs,framermotion,gsap)](https://skillicons.dev)

### 🚀 Deployment & CI/CD
[![My Skills](https://skillicons.dev/icons?i=vercel,netlify,githubactions,sentry)](https://skillicons.dev)
